حاضر — ضفت للـ **README** شوية حاجات مهمة ومفيدة: خيارات السطر، أمثلة استخدام متقدمة، قائمة payloads، كيف يتم التأكيد (detection logic)، تنسيقات التقرير، مذكرة أخلاقيات/قانون، كيفية المساهمة، ورقم إصدار/changelog صغير. هات النسخة الكاملة بالإنجليزي جاهزة ترفعها كـ `README.md`:
...
```bash
curl -Lo Redirect_Fox.sh https://raw.githubusercontent.com/yourusername/Redirect_Fox/main/Redirect_Fox.sh
chmod +x Redirect_Fox.sh
```
